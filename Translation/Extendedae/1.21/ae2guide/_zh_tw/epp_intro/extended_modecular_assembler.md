...
它能夠同時進行 8 項合成作業，且運作速度是原版的 2 倍快。

> 注意：你的 ME 網路中需要先有<ItemLink id="ae2:crafting_accelerator" />，才能正常執行平行作業。

然而，它只支援來自 <ItemLink id="ae2:pattern_provider" /> 分派的合成作業。因此你無法直接將樣板放進組裝機中。
