...
### 支援的擴充模組：
- 應用通量 - Applied Flux
- 應用能源 2｜通用機械擴充 - Applied Mekanistics
- 應用能源 2｜植物魔法擴充 - Applied Botanics Addon
...
當 ME 裝罐機從 <ItemLink id="ae2:pattern_provider" /> 接收原材料時，將會自動向其發送裝填完的物品回網路。
